...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modules_slick__ = __webpack_require__(308);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_eventListeners__ = __webpack_require__(309);
...
document.addEventListener("DOMContentLoaded", () => {
  Object(__WEBPACK_IMPORTED_MODULE_1__modules_slick__["a" /* carausel */])();
  Object(__WEBPACK_IMPORTED_MODULE_2__modules_eventListeners__["a" /* click */])();
  Object(__WEBPACK_IMPORTED_MODULE_2__modules_eventListeners__["b" /* input */])();
});
...
module.exports = !__webpack_require__(87) && !__webpack_require__(120)(function () {
  return Object.defineProperty(__webpack_require__(304)('div'), 'a', {
    get: function () {
      return 7;
    }
  }).a != 7;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fights_js__ = __webpack_require__(310);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__header__ = __webpack_require__(311);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__editor__ = __webpack_require__(312);
...
const click = () => {
  body.addEventListener('click', e => {
    if (e.target.closest('.fights__button')) {
      Object(__WEBPACK_IMPORTED_MODULE_0__fights_js__["b" /* fightsChange */])(e.target.closest('.fights__button'));
    } else if (e.target.closest('.fights-block__fight  ')) {
      Object(__WEBPACK_IMPORTED_MODULE_0__fights_js__["c" /* popupFight */])(e.target.closest('.fights-block__fight  '));
    } else if (e.target.closest('.nav__item')) {
      Object(__WEBPACK_IMPORTED_MODULE_1__header__["a" /* popupMenu */])(e.target.closest('.nav__item'));
    } else if (e.target.closest('.fighter__edit_open')) {
      Object(__WEBPACK_IMPORTED_MODULE_2__editor__["c" /* openEditor */])(e.target.closest('.fighter__edit_open'));
    } else if (e.target.closest('.fighter__edit_close')) {
      Object(__WEBPACK_IMPORTED_MODULE_2__editor__["b" /* closeEditor */])(e.target.closest('.fighter__edit_close'));
    } else {
      Object(__WEBPACK_IMPORTED_MODULE_0__fights_js__["a" /* closePopupFight */])();
      Object(__WEBPACK_IMPORTED_MODULE_1__header__["b" /* popupMenuClose */])();
    }
  });
};
...
const input = () => {
  body.addEventListener('input', e => {
    if (e.target.closest('.fighter__weight')) {
      Object(__WEBPACK_IMPORTED_MODULE_2__editor__["a" /* checkingInput */])(e.target.closest('.fighter__weight'));
    } else if (e.target.closest('.fighter__height')) {
      Object(__WEBPACK_IMPORTED_MODULE_2__editor__["a" /* checkingInput */])(e.target.closest('.fighter__height'));
    }
  });
};
...
/* harmony export (immutable) */ __webpack_exports__["b"] = fightsChange;

const popupFight = block => {
...
/* harmony export (immutable) */ __webpack_exports__["c"] = popupFight;

const closePopupFight = () => {
  document.querySelectorAll('.popup-fighters').forEach(item => item.style.display = 'none');
};
/* harmony export (immutable) */ __webpack_exports__["a"] = closePopupFight;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = popupMenu;

const popupMenuClose = () => {
  menu.style.display = 'none';
  [...nav.children].forEach(i => i.classList.remove('nav__item_choozen'));
};
/* harmony export (immutable) */ __webpack_exports__["b"] = popupMenuClose;
...
"use strict";
const [maxHeight, minHeight, maxWeight, minWeight] = [220, 150, 150, 60]; //Запрет ввода роста больше 299
...
const openEditor = button => {
  [...button.parentNode.children].forEach(item => {
    item.classList.contains('fighter__parametrs') ? item.classList.toggle('fighter__parametrs_none') : item.classList.contains('fighter__edit') ? item.classList.toggle('fighter__edit_none') : item;
  });
};
/* harmony export (immutable) */ __webpack_exports__["c"] = openEditor;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = closeEditor;

const checkingInput = input => {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = checkingInput;
